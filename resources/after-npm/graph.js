...
Graph.prototype.renderStr = function(str, name_or_callback, errback) {
...
// Compatibility
Graph.prototype.outputStr = function(str, name_or_callback, errback) {
    this.renderStr(str, name_or_callback, errback);
}
