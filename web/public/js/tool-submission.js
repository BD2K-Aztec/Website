...
(function (factory) {
    ...
    tPreview = '<div class="file-preview {class}">\n' +
        ...
        '    </div>\n' +
        '</div>';
    tClose = '<div id="removeX" class="close fileinput-remove">&times;</div>\n';
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '</div>';
    //noinspection HtmlUnknownAttribute
    tActionDelete = '<button id="removeBtn" type="button" class="kv-file-remove {removeClass}" ' + 'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
